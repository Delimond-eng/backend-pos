                ...
                <div class="card-header justify-content-between">
                    ...
                    <div class="d-flex">
                        <div class="me-2 mb-3 mb-sm-0">
                            <input v-model="search" class="form-control border-primary-subtle" type="text" placeholder="Recherche produit " aria-label=".form-control-sm example">
                        </div>
                        <div class="me-2 mb-3 mb-sm-0">
                        ...
                        <div class="me-2 mb-3 mb-sm-0 input-group">
